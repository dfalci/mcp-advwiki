...
3. If no project, service, or component is clear:
...
> Last updated: {date} | Context: {session, ticket, PR, or investigation}
...
- Whenever relevant new pages are created for a project or module, Claude should suggest or execute, if it is part of the user's request, an update to the corresponding root page.
